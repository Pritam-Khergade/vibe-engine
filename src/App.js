...
const DISCOVERY_DATA = {
  energized: [
    ...
    { artist: 'Dua Lipa',                track: 'Levitating',             genre: 'Dance Pop',               listeners: '48M',   via: '',              why: '' },
    { artist: 'The Weeknd',              track: 'Blinding Lights',        genre: 'Synth Pop',               listeners: '65M',   via: '',              why: '' },
    { artist: 'Post Malone',             track: 'Rockstar',               genre: 'Hip Hop',                 listeners: '42M',   via: '',              why: '' },
    { artist: 'Kanye West',              track: 'POWER',                  genre: 'Hip Hop',                 listeners: '38M',   via: '',              why: '' },
    ...
    { artist: 'Mika Singh',              track: 'Mauja Hi Mauja',         genre: 'Bollywood',               listeners: '9.2M',  via: '',              why: '' },
    { artist: 'Honey Singh',             track: 'Lungi Dance',            genre: 'Bollywood Hip Hop',       listeners: '11M',   via: '',              why: '' },
    { artist: 'Garry Sandhu',            track: 'Tenu Suit Suit Karda',   genre: 'Punjabi Pop',             listeners: '7.8M',  via: '',              why: '' },
    { artist: 'Imran Khan',              track: 'Amplifier',              genre: 'Punjabi Pop',             listeners: '14M',   via: '',              why: '' },
    { artist: 'Bilal Saeed',             track: '12 Saal',                genre: 'Punjabi Pop',             listeners: '9.4M',  via: '',              why: '' },
  ],
  focused: [
    ...
    { artist: 'Ludovico Einaudi',        track: 'Experience',             genre: 'Neoclassical',            listeners: '8.4M',  via: '',              why: '' },
    { artist: 'Hans Zimmer',             track: 'Time',                   genre: 'Cinematic',               listeners: '12M',   via: '',              why: '' },
    { artist: 'Yann Tiersen',            track: 'Comptine d un autre ete', genre: 'Neoclassical',          listeners: '6.2M',  via: '',              why: '' },
    { artist: 'Explosions in the Sky',   track: 'Your Hand in Mine',      genre: 'Post Rock',               listeners: '2.8M',  via: '',              why: '' },
    { artist: 'A.R. Rahman',             track: 'Lukka Chuppi',           genre: 'Bollywood Classical',     listeners: '7.4M',  via: '',              why: '' },
    { artist: 'Harshdeep Kaur',          track: 'Maahi Ve',               genre: 'Sufi Pop',                listeners: '4.1M',  via: '',              why: '' },
